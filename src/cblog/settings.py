...
db_endpoint = open("/home/ubuntu/terraform-aws-project/src/cblog/dbserver.endpoint", 'r', encoding='UTF-8') 
...
AWS_STORAGE_BUCKET_NAME = 'aws-dursun-blog' # please enter your s3 bucket name
